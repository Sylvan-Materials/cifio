...
all: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26  -Iinclude  -Icpp_modules/fmt/dist/include -Icpp_modules/lemon/dist/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include  -Isrc -Icpp_modules/json-thresher/include -Icpp_modules/urlcpp -Icpp_modules/openssl/openssl/include -Icpp_modules/mio/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/usr/local/lib -MMD
all: LDFLAGS= -Wl,--allow-multiple-definition -shared  -fuse-ld=gold -Lcpp_modules/lemon/dist/lib -L$(LUA_HOME)/install/lib -Lcpp_modules/urlcpp -L$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/lib -Lcpp_modules/zlib/dist/lib -Lcpp_modules/openssl/openssl/lib -Lcpp_modules/openssl/openssl/lib64 -Lcpp_modules/json-thresher -Lcpp_modules/xml-thresher -llua -lantlr4-runtime -lemon -lurlcpp -ljsonthresher -lxmlthresher -lz -ldl -pthread -lssl -lcrypto
...
build/src/PeriodicTable.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(MODULE_DIRECTORY)/fmt/include -I$(MODULE_DIRECTORY)/expected/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -Icpp_modules/json-thresher/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include -MMD
build/src/PeriodicTable.o: src/PeriodicTable.cpp
	@mkdir -p $(@D)
	$(CXX) $(CXXFLAGS) -c -o build/src/PeriodicTable.o src/PeriodicTable.cpp

build/src/standards/AminoStandards.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include -Icpp_modules/fmt/include -Icpp_modules/json-thresher/include -Icpp_modules/mio/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/standards/ComponentStandards.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include -Icpp_modules/fmt/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -Icpp_modules/json-thresher/include -Icpp_modules/mio/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/density/Populator.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/lattice/Populator.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/jgf/JGFPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/gz/CIFCompressor.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/smiles/SMILESPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD -Wl,--allow-multiple-definition
...
build/src/publishing/st/Publisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/CIFPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/OBJPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/TIKZPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/SVGPublisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/MOL2Publisher.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/reading/tcp/TCPReader.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/urlcpp -Icpp_modules/openssl/openssl/include -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/constitution/Graph.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26  -Iinclude -Icpp_modules/lemon/dist/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -MMD
...
build/src/dynamics/Particles.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26  -Iinclude -Icpp_modules/lemon/dist/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -MMD  -Wl,--allow-multiple-definition
...
build/src/constitution/Comparator.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26  -Iinclude -Icpp_modules/lemon/dist/include -I$(MODULE_DIRECTORY)/expected/include -I$(MODULE_DIRECTORY)/expected/include -Icpp_modules/graph-v3/include -MMD
...
build/src/parsing/CIFLexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/CIFParser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/CIF2Lexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/CIF2Parser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/DICLexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/DICParser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/MOL2Lexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/MOL2Parser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/SMIRKSLexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/SMIRKSParser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I$(MODULE_DIRECTORY)/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
