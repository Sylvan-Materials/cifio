...
all: CXXFLAGS= -DNDEBUG -O3 -pthread -fopenmp -std=c++26  -Iinclude  -Icpp_modules/fmt/dist/include -Icpp_modules/lemon/dist/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include  -Isrc -Icpp_modules/json-thresher/include -Icpp_modules/urlcpp -Icpp_modules/openssl/openssl/include -Icpp_modules/mio/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/usr/local/lib -MMD
all: LDFLAGS= -Wl,--allow-multiple-definition -shared  -fuse-ld=gold -Lcpp_modules/lemon/dist/lib -L$(JAVA_HOME)/lib -L$(LUA_HOME)/install/lib -L$(JAVA_HOME)/lib/server -Lcpp_modules/urlcpp -L./cpp_modules/antlr4/runtime/Cpp/run/lib -Lcpp_modules/zlib/dist/lib -Lcpp_modules/fmt/dist/lib -Lcpp_modules/openssl/openssl/lib -Lcpp_modules/openssl/openssl/lib64 -Lcpp_modules/json-thresher -Lcpp_modules/xml-thresher -ljvm -llua -lantlr4-runtime -lemon -lurlcpp -lfmt -ljsonthresher -lxmlthresher -lz -ldl -pthread -lssl -lcrypto
all: build/src/PeriodicTable.o build/src/parsing/CIF2Lexer.o build/src/parsing/CIF2Parser.o build/src/parsing/CIFLexer.o build/src/parsing/CIFParser.o build/src/parsing/DICLexer.o build/src/parsing/DICParser.o build/src/parsing/MOL2Lexer.o build/src/parsing/MOL2Parser.o build/src/parsing/SMIRKSLexer.o build/src/parsing/SMIRKSParser.o build/src/constitution/Graph.o build/src/dynamics/Particles.o build/src/constitution/Comparator.o build/src/reading/smirnoff/SMIRKSPatterns.o build/src/forcefield/OpenFF.o build/src/constitution/Populator.o build/src/constitution/MOL2Populator.o build/src/constitution/GraphmlPopulator.o build/src/density/Populator.o build/src/standards/AminoStandards.o build/src/standards/ComponentStandards.o build/src/symmetry/LatticeSites.o build/src/lattice/Populator.o build/src/reading/tcp/TCPReader.o build/src/publishing/st/Publisher.o build/src/publishing/st/CIFPublisher.o build/src/publishing/st/OBJPublisher.o build/src/publishing/st/TIKZPublisher.o build/src/publishing/st/SVGPublisher.o build/src/publishing/st/MOL2Publisher.o build/src/publishing/jgf/JGFPublisher.o build/src/publishing/gz/CIFCompressor.o build/src/publishing/smiles/SMILESPublisher.o build/src/utils/JVMSingleton.o $(if $(findstring $(mode),extra), build/src/guile/guile-cifio.o) /home/roger/sylvanmats/lua-5.4.3/install/lib/liblua.a
...
build/src/PeriodicTable.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/fmt/include -Icpp_modules/json-thresher/include -Icpp_modules/brigand/include -Icpp_modules/multi_index/include -MMD
...
build/src/publishing/jgf/JGFPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/gz/CIFCompressor.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/smiles/SMILESPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD -Wl,--allow-multiple-definition
...
build/src/publishing/st/Publisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/CIFPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/OBJPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/TIKZPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/SVGPublisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/publishing/st/MOL2Publisher.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/fmt/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/utils/JVMSingleton.o: CXXFLAGS= -DNDEBUG -fPIC -O3 -pthread -fopenmp -std=c++26 -Iinclude -Isrc -I$(JAVA_HOME)/include -I$(JAVA_HOME)/include/linux -Icpp_modules/lemon/dist/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/reading/tcp/TCPReader.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pedantic -pthread -fopenmp -std=c++26 -Iinclude -Isrc -Icpp_modules/lemon/dist/include -Icpp_modules/urlcpp -Icpp_modules/openssl/openssl/include -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
