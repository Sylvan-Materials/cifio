...
all: LDFLAGS= -Wl,--allow-multiple-definition -shared  -fuse-ld=gold -Lcpp_modules/lemon/dist/lib -L$(LUA_HOME)/install/lib -Lcpp_modules/urlcpp -L./cpp_modules/antlr4/runtime/Cpp/run/lib -Lcpp_modules/zlib/dist/lib -Lcpp_modules/openssl/openssl/lib -Lcpp_modules/openssl/openssl/lib64 -Lcpp_modules/json-thresher -Lcpp_modules/xml-thresher -llua -lantlr4-runtime -lemon -lurlcpp -ljsonthresher -lxmlthresher -lz -ldl -pthread -lssl -lcrypto
