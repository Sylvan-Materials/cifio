...
all: build/src/parsing/CIF2Lexer.o build/src/parsing/CIF2Parser.o build/src/parsing/CIFLexer.o build/src/parsing/CIFParser.o build/src/parsing/DICLexer.o build/src/parsing/DICParser.o build/src/constitution/graph.o build/src/constitution/Populator.o build/src/density/Populator.o build/src/standards/AminoStandards.o build/src/standards/ComponentStandards.o build/src/lattice/Populator.o build/src/reading/tcp/TCPReader.o build/src/publishing/st/Publisher.o build/src/publishing/st/CIFPublisher.o build/src/publishing/st/OBJPublisher.o build/src/publishing/st/SVGPublisher.o build/src/publishing/jgf/JGFPublisher.o build/src/publishing/gz/CIFCompressor.o build/src/utils/JVMSingleton.o
	$(CXX) $(LDFLAGS) -o libcifio.so $(wildcard build/src/*.o) $(wildcard build/src/parsing/*.o) $(wildcard build/src/standards/*.o) $(wildcard build/src/constitution/*.o) $(wildcard build/src/density/*.o) $(wildcard build/src/lattice/*.o) $(wildcard build/src/reading/tcp/*.o) $(wildcard build/src/publishing/jgf/*.o) $(wildcard build/src/publishing/gz/*.o) $(wildcard build/src/publishing/st/*.o) $(wildcard build/src/utils/*.o) 
...
build/src/parsing/CIF2Parser.o: src/parsing/CIFParser.cpp 
