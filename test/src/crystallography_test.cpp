...
//    CHECK(space.cStar == doctest::Approx(0.058613));
    ...
    sylvanmats::publishing::st::TIKZPublisher tikzPublisher(tikzPath);
    sylvanmats::linear::Vector3d vOAxis;
    sylvanmats::linear::Vector3d vXAxis(space.cell.a, 0.0, 0.0);
    sylvanmats::linear::Vector3d vYAxis(0.0, space.cell.b, 0.0);
    sylvanmats::linear::Vector3d vZAxis(0.0, 0.0, space.cell.c);
    sylvanmats::linear::Vector3d vABAxis(space.cell.a, space.cell.b, 0.0);
    sylvanmats::linear::Vector3d vBCAxis(0.0, space.cell.b, space.cell.c);
    sylvanmats::linear::Vector3d vACAxis(space.cell.a, 0.0, space.cell.c);
    sylvanmats::linear::Vector3d vABCAxis(space.cell.a, space.cell.b, space.cell.c);
    tikzPublisher.append("", "O", vOAxis);
    tikzPublisher.append("r_i", "a", vXAxis);
    tikzPublisher.append("r_j", "b", vYAxis);
    tikzPublisher.append("r_k", "c", vZAxis);
    ...
    tikzPublisher.draw("O", "b");
    tikzPublisher.draw("O", "c");
    vXAxis=space.GStar*vXAxis*10.0;
    vYAxis=space.GStar*vYAxis*10.0;
    vZAxis=space.GStar*vZAxis*10.0;
    vABAxis=space.GStar*vABAxis*10.0;
    vBCAxis=space.GStar*vBCAxis*10.0;
    vACAxis=space.GStar*vACAxis*10.0;
    vABCAxis=space.GStar*vABCAxis*10.0;
//    tikzPublisher.append("", "O", vOAxis);
    tikzPublisher.append("a", "ap", vXAxis);
    tikzPublisher.append("b", "bp", vYAxis);
    tikzPublisher.append("c", "cp", vZAxis);
    tikzPublisher.append("", "abp", vABAxis);
    tikzPublisher.append("", "bcp", vBCAxis);
    tikzPublisher.append("", "acp", vACAxis);
    tikzPublisher.append("", "abcp", vABCAxis);
    tikzPublisher.draw("O", "ap");
    tikzPublisher.draw("O", "bp");
    tikzPublisher.draw("O", "cp");
    tikzPublisher.draw("ap", "abp");
    tikzPublisher.draw("ap", "acp");
    tikzPublisher.draw("bp", "bcp");
    tikzPublisher.draw("bp", "abp");
    tikzPublisher.draw("cp", "acp");
    tikzPublisher.draw("cp", "bcp");
    tikzPublisher.draw("abp", "abcp");
    tikzPublisher.draw("bcp", "abcp");
    tikzPublisher.draw("acp", "abcp");
    std::string&& content = tikzPublisher.render();
    std::ofstream ofs("../documents/reciprocal_drawing.tex");
    ofs<<content<<std::endl;
